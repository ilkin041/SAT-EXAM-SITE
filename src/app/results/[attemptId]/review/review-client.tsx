...
function AiExplanationBox({ item }: { item: ReviewItem }) {
  ...
  return (
    <div className="mt-5 rounded-xl border border-indigo-200 bg-indigo-50/50 p-5 dark:border-indigo-900/40 dark:bg-indigo-950/20">
      ...
      {aiExplanation && (
        <div className="max-h-[32rem] overflow-y-auto prose prose-sm dark:prose-invert max-w-none prose-p:leading-relaxed prose-pre:bg-indigo-950/50 text-indigo-950 dark:text-indigo-100">
