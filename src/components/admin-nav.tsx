...
export function AdminNav({ email }: Props) {
  return (
    // The navy bar is this component's one gradient — the whole admin section's
    // budget. Logo mark and badge below are deliberately solid.
    <header className="sticky top-0 z-40 border-b border-white/[0.08] bg-gradient-to-r from-brand-navy via-brand-navy-light to-brand-navy text-white shadow-md">
      <div className="container mx-auto flex h-14 max-w-6xl items-center justify-between gap-4 px-4">
        ...
        <div className="flex items-center gap-3 text-sm">
          <div className="hidden items-center gap-2 sm:flex">
            <span className="rounded-full border border-white/20 bg-white/10 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white">
              Admin
            </span>
